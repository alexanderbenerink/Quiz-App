  ...
  class QuizCreator {
    ...
    public function drawQuestionPanel() {
      ...
      for ( $i = 0; $i < $this -> numbOfQuestions; $i++ ) {
        ...
        $questionPanel .= "<div id='fieldset-q$questionNumber'>";
        $questionPanel .= $this -> drawImageQuestion( $questionNumber );
        $questionPanel .= "</div>";
    ...
    public function checkPreferredQuestionType( $type, $returnValue ) {
      switch ( $type ) {
        ...
        if ( $this -> preferredQuestionType == $type ) {
          $currentFieldset = drawMultipleChoiceFieldset();
          return $returnValue;
        } else {
          return "";
        }
        ...
        case "true-false":
        if ( $this -> preferredQuestionType == $type ) {
          $currentFieldset = drawTrueFalseFieldset();
          return $returnValue;
        } else {
          return "";
        }
    ...
    // Geeft de HTML terug voor het renderen van de fieldset met betrekking tot multiple-choice vragen 
        ...
        <fieldset>
          ...
          <fieldset>
            ...
            <fieldset>
              ...
              <input type='text' name='multiple-choice_incorrect-1-$questionNumber' required>
              <input type='text' name='multiple-choice_correct-2-$questionNumber' required>
              <input type='text' name='multiple-choice_correct-3-$questionNumber' required>
            </fieldset>
          </fieldset>
        </fieldset>
      ";
    ...
    // Geeft de HTML terug voor het renderen van de fieldset met betrekking tot true-false vragen
      ...
      return "
        <fieldset>
          ...
          <fieldset>
            ...
            <fieldset>
              <legend>Correct</legend>
              <input type='text' name='true-false_correct-1-$questionNumber' required>
            </fieldset>
            <fieldset>
              <legend>Incorrect</legend>
              <input type='text' name='true-false_incorrect-1-$questionNumber' required>
            </fieldset>
          </fieldset>
        </fieldset>
      ";
    ...
    // Geeft de HTML terug voor het renderen van de fieldset met betrekking tot image vragen
    public function drawImageQuestion( $questionNumber ) {
      return "
        <fieldset>
