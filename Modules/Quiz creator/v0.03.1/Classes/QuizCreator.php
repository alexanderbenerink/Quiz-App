  ...
  class QuizCreator {
    ...
    public function collectResults() {
      ...
      for ( $i = 0; $i < $numbOfQuestions; $i++ ) {
        $number = $i + 1;
        $results[$i] = array( "id" => $number, "type" => $_POST["type-q$number"], "question" => $_POST["multiple-choice_question-$number"], "correct" => $_POST["multiple-choice_correct-$number"], "points" => $_POST["points-q$number"], "time" => $_POST["time-q$number"] );
        echo "
          <p>Question number: " . $results[$i]['id'] . "<br>
            Question: " . $results[$i]['question'] . "<br>
            Question correct: " . $results['correct'][$i] . " <br>
            Question incorrect-1: " . " <br>
            Question incorrect-2: <br>
            Question incorrect-3: <br>
