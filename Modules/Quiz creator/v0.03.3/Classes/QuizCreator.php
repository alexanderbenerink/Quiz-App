  ...
  class QuizCreator {
    ...
    public function collectResults() {
      ...
      for ( $i = 0; $i < $numbOfQuestions; $i++ ) {
        ...
        print_r( $quizRecord );
        //echo $_POST["type-q$number"];
      }
      // $results = array();
      // for ( $i = 0; $i < $numbOfQuestions; $i++ ) {
      //   $number = $i + 1;
      //   $results[$i] = array( "id" => $number, "name" => $_POST["quiz_name"], "type" => $_POST["type-q$number"], "question" => $_POST["multiple-choice_question-$number"], "correct" => $_POST["multiple-choice_correct-$number"], "incorrect-1" => $_POST["multiple-choice_incorrect-$number-1"], "incorrect-2" => $_POST["multiple-choice_incorrect-$number-2"], "incorrect-3" => $_POST["multiple-choice_incorrect-$number-3"], "points" => $_POST["points-q$number"], "time" => $_POST["time-q$number"] );
      //   echo "
      //     <p>Question number: " . $results[$i]['id'] . "<br>
      //       Question name: " . $results[$i]['name'] . "<br>
      //       Question: " . $results[$i]['question'] . "<br>
      //       Correct: " . $results[$i]['correct'] . " <br>
      //       Incorrect-1: " . $results[$i]['incorrect-1'] . " <br>
      //       Incorrect-2: " . $results[$i]['incorrect-2'] . " <br>
      //       Incorrect-3: " . $results[$i]['incorrect-3'] . " <br>
    ...
    public function collectMultipleChoice() {
